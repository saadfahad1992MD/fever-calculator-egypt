...
export function ShareModal({ isOpen, onClose }) {
  ...
  const shareOnWhatsApp = () => {
    const text = encodeURIComponent('موقع حرارة - حاسبة جرعات خافض الحرارة للأطفال\n' + websiteUrl)
    window.open(`https://wa.me/?text=${text}`, '_blank')
  }

  const shareOnTwitter = () => {
    const text = encodeURIComponent('موقع حرارة - حاسبة جرعات خافض الحرارة للأطفال')
    window.open(`https://twitter.com/intent/tweet?text=${text}&url=${websiteUrl}`, '_blank')
  }
